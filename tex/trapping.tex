...
We can now construct the non-axisymmetric solution. We plot
$|\rho_2|/|\rho_0|$ as a function of $z$ in \fig{fig:nonaxi}, 
for $\chi=10$ and $\rm{St}=0.3$. Even for such a not-so-small Stokes
number, the dust is nearly axisymmetric up to $z\sim 1$, i.e. in the
vortex core.  
...
small for $\rm{St}\ll1$. We conclude that the vortex core is
effectively axisymmetric.   
