...
$\rho_2$ is a small perturbation to the axisymmetric solution. 
...
\epsilon(x) = \frac{\tilde{\chi}^2D_0k_0^3xJ_1(k_0x)}{2\left(k_2^2 -
  k_0^2\right)}. 
\eeq
This represents another correction to the axisymmetric solution. It is
also small because of $|k_2^2|$. Furthermore, it is smaller than
$\rho_2(z)$ by a factor $\tilde{\chi}$. 
