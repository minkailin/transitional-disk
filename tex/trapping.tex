...
%While the mechanism is probably not reasonable
%(outer edges of dead zones are very smooth,


% where the main particle that gets trapped is not
%from mm to meter size, but from micron to mm-size. Whereas the focus
%of the dust trapping research on 
...
%numerical work that s

%Vortex formation has been
%considered in connection 

%was considered
%by Hawley et al. (1987), in ``thick tori'' accretion disks around
%black holes, subject to the Papaloizou-Pringle instability (1985). 



%While 2D vortices naturally coallesce out of random
%small-scale noise as a result of an inverse cascade (Batchelor 1967), 
%3D closed elliptic streamlines are rendered unstable as inertial waves propagating 
%along them find resonance with the strain field; a process that
%has been called ``elliptic instability'' (Pierrehumbert
%1986, Bayly 1986, Kerswell et al. 2002, Lesur \& Papaloizou 2009, Lyra
%2013). 
...
%The vortex excitation method would
...
%A renaissance was sparkled in the study of the RWI and other methods
%for producing vortices, such as the baroclinic instability
%(mention?). 
