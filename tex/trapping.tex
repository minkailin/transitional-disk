...
\noindent accurate to first order in $\tau$. We have assumed a
barotropic fluid for which the pressure $p=p(\rho)$ and $\rho$ is the
...
in the advection term $\bm{v}\cdot\del$. Physically, our dust-trapping
equation is then comparing advection due to the background vortex flow
and diffusion. We remark that including the $\tau$ term for dust
velocity only helps to concentrate dust at the vortex core (pressure
maximum).      
...
Gathering the above results and expanding the Bessel functions, our
...
Thus, the axisymmetric solution from the previous section causes
