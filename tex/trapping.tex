...
magneto-elliptic instability instability (see Lyra 2013 and references
...
Eq. 36, with coefficients given by Eq 55. In practice, the magnitude
of the higher non-axisymmetric modes fall fast as $m$ increases, and 
only the $m=2$ term would provide an appreaciable deviation from
axisymmetry. 


\acknowledgments W.L. acknowledges finantial support by the National Science
