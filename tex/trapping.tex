...
$\v{u}$ is the velocity of the gas. We have adopted a 
...
expression for the dust velocity is used and that term represented
...
compression and dust diffusion. %A comparison between these two
%solutions (see below) gives an indication of the region within which    

%Clearly it is negligible 
%for sufficiently small $a$, because as $a\to0$ there is no
%advection. 
